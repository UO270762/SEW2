    ...
    cargarDatos(){
        $.ajax({
            ...
            success: function(datos){
                $("p").text((new XMLSerializer()).serializeToString(datos)); 
                ...
                var stringDatos = '<img src= "http://openweathermap.org/img/w/' + icon + '.png" height="64px" width="64px">';
                stringDatos += "<li>Número de elementos del XML: " + totalNodos + "</li>";
                stringDatos += "<li>Poblacion: " + ciudad + "</li>";
